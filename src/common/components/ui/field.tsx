/** biome-ignore-all lint/a11y/useSemanticElements: Field components intentionally use non-semantic elements for flexibility and consistent styling across browsers. */
