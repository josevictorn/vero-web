...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: Setting document.cookie is required here to persist the sidebar's open/closed state across sessions. There is no safe or reliable alternative for synchronizing this UI preference outside the component scope, and the value is not user input or sensitive data.
